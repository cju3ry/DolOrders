...
import com.example.dolorders.Commande; // Assure-toi d'importer ta classe modèle
import com.example.dolorders.R;
import java.text.SimpleDateFormat;
import java.util.List;
import java.util.Locale;

public class CommandesAttenteAdapter extends RecyclerView.Adapter<CommandesAttenteAdapter.ViewHolder> {

    private final List<Commande> commandes;

    public CommandesAttenteAdapter(List<Commande> commandes) {
