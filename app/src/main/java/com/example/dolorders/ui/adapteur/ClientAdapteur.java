...
public class ClientAdapteur extends RecyclerView.Adapter<ClientAdapteur.ClientViewHolder> {
    ...
    // ✅ 3) CONSTRUCTEUR
    public ClientAdapteur(List<Client> clients, OnClientActionListener listener) {
