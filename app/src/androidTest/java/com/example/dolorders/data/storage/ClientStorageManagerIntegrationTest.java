...
public class ClientStorageManagerIntegrationTest {

    private TestClientStorageManager storageManager;
    ...
    public void setUp() {
        ...
        storageManager = new TestClientStorageManager(context);
    ...
    public void persistance_EntreDeuxInstances_LeFichierEstPartage() {
        ...
        TestClientStorageManager manager1 = new TestClientStorageManager(context);
        manager1.addClient(clientTest1);

        // Deuxième instance : chargement depuis le même fichier de test
        TestClientStorageManager manager2 = new TestClientStorageManager(context);
    ...
    public void fichierTest_EstSepareDeFichierProduction() {
        ...
        TestClientStorageManager testManager = new TestClientStorageManager(context);
        ...
        ClientStorageManager prodManager = new ClientStorageManager(context);
